...
insert into menu(nombre_platillo, elaboracion, precio) values('Torta', 'Elaborado con telera, lechuga, jitomate, cebolla, chiles encurtidos, aderezo y el guisado de su preferencia.', 25);
...
insert into menu(nombre_platillo, elaboracion, precio) values('Sandwich', 'Elaborado con pan blancode caja, con vegetales frescos y el guisado de su preferencia.',20);
